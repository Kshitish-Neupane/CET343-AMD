...
class YogaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.tvTitle).text = "Morning Yoga Flow"
        ...
        val list = mutableListOf(
            RoutineItem("Sun Salutation", "Yoga Mat", "5 min", "1", recommended = true),
            RoutineItem("Downward Dog", "Yoga Mat", "1 min", "3", recommended = true),
            RoutineItem("Child's Pose", "Yoga Mat", "2 min", "2", recommended = false)
        )
        ...
        findViewById<RecyclerView>(R.id.rvList).apply {
            layoutManager = LinearLayoutManager(this@YogaActivity)
            adapter = this@YogaActivity.adapter
        }
